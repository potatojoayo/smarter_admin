...
export default class Draft {
	...
	async save({
		...
		if (this.id > 0) {
			result =
				await NewDraftService.updateNewDraft({
					draftId: this.id,
					file,
					draft: {
					...
					sizes: this.sizes.map((d) => {
						return {
							...
							leftShoulderWidth:
								d.leftShoulderWidth,
							leftShoulderHeight:
								d.leftShoulderHeight,
							rightShoulderWidth:
								d.rightShoulderWidth,
							rightShoulderHeight:
								d.rightShoulderHeight,
							heapWidth: d.heapWidth,
							heapHeight: d.heapHeight,
							leftPantMiddleWidth:
								d.leftPantMiddleWidth,
							leftPantMiddleHeight:
								d.leftPantMiddleHeight,
							rightPantMiddleWidth:
								d.rightPantMiddleWidth,
							rightPantMiddleHeight:
								d.rightPantMiddleHeight,
							leftPantLowWidth:
								d.leftPantLowWidth,
							leftPantLowHeight:
								d.leftPantLowHeight,
			...
			result =
				await NewDraftService.createNewDraft({
					userId: userId!,
					file: file!,
